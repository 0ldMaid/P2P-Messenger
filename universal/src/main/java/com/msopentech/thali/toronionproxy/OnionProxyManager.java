...
public class OnionProxyManager {
    ...
    public synchronized int getIPv4LocalHostSocksPort() throws IOException {
        ...
        //System.out.println("X " + controlConnection.getInfo());
        System.out.println("X " + socksIpPorts.length);
        System.out.println("X " + socksIpPorts[0]);
     ...
     */
    public synchronized String getStartUpStatus() {
    ...
    private void waitForControlPortFileCreation(File controlPortFile) throws IOException {
        ...
        System.out.println("controlPortFile " + controlPortFile.length() + " " + controlPortFile.getName() + " " + controlPortFile.exists());
        System.out.println("isCreated       " + isCreated);
        System.out.println("size            " + controlPortFile.length());
        System.out.println("Observer        " + controlPortFileObserver.poll(config.getFileCreationTimeout(), SECONDS));
    ...
    private void waitForCookieAuthFileCreation(File cookieAuthFile) throws IOException {
        ...
        //if (!isCreated || cookieAuthFile.length() != 0) {
